                        ...
                        <x-table.tr>
                            ...
                            <x-table.td :tooltip="true">
                                <div class="flex items-center gap-2">
                                    <div
                                        class="h-6 w-6 rounded-full bg-gradient-to-br from-indigo-500 to-purple-500 flex items-center justify-center text-white text-[10px] font-bold flex-shrink-0">
                                        {{ substr($session->creator->name, 0, 1) }}
                                    </div>
                                    <span
                                        class="text-slate-600 dark:text-slate-400 text-sm font-medium truncate">{{ $session->creator->name }}</span>
                                </div>
                            </x-table.td>
