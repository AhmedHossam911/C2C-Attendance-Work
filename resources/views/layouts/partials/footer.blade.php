        ...
        <div class="flex flex-col md:flex-row items-center justify-between gap-4">
            ...
            <div class="flex items-center gap-2 text-sm text-slate-500 dark:text-slate-400">
                ...
                <a href="https://linktr.ee/Ahmed_911" target="_blank"
                    class="font-bold text-brand-blue dark:text-blue-400 hover:text-brand-teal dark:hover:text-teal-400 flex items-center gap-1 transition-colors">
                    Ahmed Hossam
                    <span
                        class="text-blue-700 dark:text-blue-300 text-[10px] px-1.5 py-0.5 rounded ml-1 bg-blue-50 dark:bg-blue-900/30">President</span>
                </a>
            </div>
            ...
            <div class="flex gap-6 opacity-80 hover:opacity-100 transition-opacity">
                <a href="https://www.facebook.com/C2C.BIS.Helwan" target="_blank"
                    class="text-slate-400 hover:text-brand-blue hover:scale-110 transition-all"><i
