                        ...
                        @if (Auth::user()->hasRole('top_management'))
                            ...
                            @if (Auth::user()->hasRole('top_management'))
                                <a href="{{ route('reports.member') }}" class="sidebar-link group"
                                    :class="[
                                        {{ request()->routeIs('reports.member') ? 'true' : 'false' }} ?
                                        'sidebar-link-active !text-brand-teal bg-teal-50 dark:bg-teal-900/10' :
                                        'sidebar-link-inactive',
                                        sidebarCollapsed ? 'justify-center px-2' : ''
                                    ]"
                                    title="Member Search">
                                    <i
                                        class="bi bi-search text-lg {{ request()->routeIs('reports.member') ? '!text-brand-teal' : 'text-slate-500 group-hover:text-slate-600 dark:group-hover:text-slate-200' }}"></i>
